...
namespace UMSPROJECT1 {
	...
	private: System::Windows::Forms::Button^ RemovesectionB;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->RemovesectionB = (gcnew System::Windows::Forms::Button());
			...
			this->dataGridView1->Location = System::Drawing::Point(371, 318);
			...
			this->dataGridView1->Size = System::Drawing::Size(1532, 760);
			this->dataGridView1->TabIndex = 4;
			// 
			// button2
			// 
			this->button2->BackColor = System::Drawing::SystemColors::ActiveCaption;
			this->button2->Font = (gcnew System::Drawing::Font(L"Sitka Small", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(775, 1121);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(305, 67);
			this->button2->TabIndex = 5;
			this->button2->Text = L"ADD SECTION";
			this->button2->UseVisualStyleBackColor = false;
			// 
			// RemovesectionB
			// 
			this->RemovesectionB->BackColor = System::Drawing::SystemColors::ActiveCaption;
			this->RemovesectionB->Font = (gcnew System::Drawing::Font(L"Sitka Small", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->RemovesectionB->Location = System::Drawing::Point(1115, 1121);
			this->RemovesectionB->Name = L"RemovesectionB";
			this->RemovesectionB->Size = System::Drawing::Size(349, 67);
			this->RemovesectionB->TabIndex = 6;
			this->RemovesectionB->Text = L"REMOVE SECTION";
			this->RemovesectionB->UseVisualStyleBackColor = false;
			// 
			// SectionWiseTT
			// 
			...
			this->Controls->Add(this->RemovesectionB);
...
#pragma endregion
	private: System::Void SectionWiseTT_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			section->Open();
			String^ burger = "SELECT FROM sectionwise WHERE SectionName=@SectionName";
